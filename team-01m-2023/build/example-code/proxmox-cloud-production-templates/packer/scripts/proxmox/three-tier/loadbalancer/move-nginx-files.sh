...
sudo cp -v /home/vagrant/team-01m-2023/code/nginx/nginx.conf /etc/nginx/
sudo cp -v /home/vagrant/team-01m-2023/code/nginx/default /etc/nginx/sites-available/
# This connects the TLS certs built in this script with the instances
sudo cp -v /home/vagrant/team-01m-2023/code/nginx/self-signed.conf /etc/nginx/snippets/
